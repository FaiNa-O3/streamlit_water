...
last_watering = ctrl.Antecedent(np.arange(0, 15, 1), 'last_watering')
...
watering_time['VeryShort'] = fuzz.trapmf(watering_time.universe, [1, 1, 10, 20])
...
watering_time['VeryLong'] = fuzz.trapmf(watering_time.universe, [80, 95, 110, 120])
...
rule16 = ctrl.Rule(humidity_type['dry']      | sunshine_hour ['long'] | sun_radiation ['heavy'] |delta_evaporation ['medium']|last_watering['short'], watering_time['Medium'])
...
rule36 = ctrl.Rule(humidity_type['wet']      | sunshine_hour ['long'] | sun_radiation ['heavy'] |delta_evaporation ['small']|last_watering['medium'], watering_time['Medium'])


rule37 = ctrl.Rule(humidity_type['dry']      | sunshine_hour ['short'] | sun_radiation ['light'] |delta_evaporation ['medium']|last_watering['medium'], watering_time['Short'])
...
rule45 = ctrl.Rule(humidity_type['wet']      | sunshine_hour ['long'] | sun_radiation ['heavy'] |delta_evaporation ['medium']|last_watering['medium'], watering_time['Medium'])


rule46 = ctrl.Rule(humidity_type['dry']      | sunshine_hour ['short'] | sun_radiation ['light'] |delta_evaporation ['large']|last_watering['medium'], watering_time['Short'])
...
rule61 = ctrl.Rule(humidity_type['dry']      | sunshine_hour ['long'] | sun_radiation ['heavy'] |delta_evaporation ['small']|last_watering['long'], watering_time['Long'])
...
rule67 = ctrl.Rule(humidity_type['dry']      | sunshine_hour ['medium'] | sun_radiation ['medium'] |delta_evaporation ['medium']|last_watering['long'], watering_time['Long'])
...
rule72 = ctrl.Rule(humidity_type['wet']      | sunshine_hour ['long'] | sun_radiation ['heavy'] |delta_evaporation ['medium']|last_watering['long'], watering_time['Long'])
...
rule75 = ctrl.Rule(humidity_type['wet']      | sunshine_hour ['short'] | sun_radiation ['light'] |delta_evaporation ['large']|last_watering['long'], watering_time['Medium'])

rule76 = ctrl.Rule(humidity_type['dry']      | sunshine_hour ['medium'] | sun_radiation ['medium'] |delta_evaporation ['large']|last_watering['long'], watering_time['Long'])
...
rule81 = ctrl.Rule(humidity_type['wet']      | sunshine_hour ['long'] | sun_radiation ['heavy'] |delta_evaporation ['large']|last_watering['long'], watering_time['Long'])
...
sunshine = st.number_input('ENTER SUNSHINE HOUR', min_value=1, max_value=14)
...
evaporation = st.number_input('ENTER DELTA EVAPORATION', min_value=1, max_value=10)
